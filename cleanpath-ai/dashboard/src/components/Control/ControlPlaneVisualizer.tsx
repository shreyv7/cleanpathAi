        ...
        <div className="card-elevated justify-between">
            ...
            <div>
                <h2 className="text-sm font-bold uppercase tracking-widest text-slate-900 dark:text-white/90 flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4 text-blue-600 dark:text-blue-500 animate-pulse" />
                    Live Control Plane Rerouting Map
                </h2>
                <p className="text-[10px] text-slate-500 dark:text-white/40 font-medium">Real-time programmatic auction paths and quarantine zones</p>
            </div>

            {/* Visual mapping of bid flow bypasses */}
            <div className="flex-1 bg-slate-900 border border-slate-950 dark:bg-[#03060a]/90 dark:border-white/5 rounded-xl p-4 my-2 relative overflow-hidden flex items-center justify-center min-h-[220px]">
                ...
                <div className="w-full flex items-center justify-between px-6 z-10 font-mono text-[9px] relative">
                    ...
                    <div className="flex flex-col items-center gap-1.5 w-20">
                        <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-450 font-bold flex items-center justify-center">
                            DSP BIDS
                        </div>
                        <span className="text-slate-400 dark:text-white/40 font-semibold">Gross Ingress</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1.5 w-20">
                        ...
                        <span className="text-slate-400 dark:text-white/40 font-semibold">Publisher Net</span>
                    </div>
                </div>
            </div>

            {/* Sub summary metrics */}
            <div className="text-[10px] font-mono text-slate-500 dark:text-white/45 flex justify-between items-center border-t border-slate-100 dark:border-white/5 pt-3">
                <span className="flex items-center gap-1 font-semibold">
                    <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping" />
                    Bypassed: Magnite Reseller-C
                </span>
                <span className="text-emerald-600 dark:text-emerald-400 font-bold">Rerouting: 100% of affected traffic</span>
            </div>
        </div>
    );
};
