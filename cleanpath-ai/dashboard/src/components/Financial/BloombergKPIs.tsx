...
export const BloombergKPIs: React.FC = () => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full select-none">
            {/* Total Media Spend */}
            <div className="card-elevated justify-between  group">
                ...
                <div>
                    <div className="text-4xl md:text-5xl font-black font-mono text-slate-900 dark:text-white/90 tracking-tight">$2,840,000</div>
            ...
            <div className="card-elevated justify-between  group">
                ...
                <div>
                    <div className="text-4xl md:text-5xl font-black font-mono text-purple-600 dark:text-purple-400 tracking-tight">
            ...
            <div className="card-elevated justify-between  group">
                ...
                <div>
                    <div className="text-4xl md:text-5xl font-black font-mono text-emerald-600 dark:text-emerald-400 tracking-tight">
