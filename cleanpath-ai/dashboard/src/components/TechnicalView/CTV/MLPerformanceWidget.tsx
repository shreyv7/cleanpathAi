...
export const MLPerformanceWidget = () => {
    ...
    const liftColor = data.agentRewardLift >= 0 ? 'text-emerald-400' : 'text-red-400';
            ...
            <div className="lg:col-span-1 flex flex-col gap-4">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
                    <div className="flex justify-between items-start mb-2">
                        <h3 className="text-sm font-medium text-white/50">RL Agent Uplift</h3>
                    ...
                    <p className="text-xs text-white/30 mt-2">vs. Rule Engine Baseline</p>
                </div>

                <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
                    <div className="flex justify-between items-start mb-2">
                        <h3 className="text-sm font-medium text-white/50">Agreement Rate</h3>
                        <Activity className="w-5 h-5 text-blue-400" />
                    </div>
                    <div className="text-3xl font-bold text-white">
                        {data.agreementRate}%
                    </div>
                    <p className="text-xs text-white/30 mt-2">Shadow Mode Consistency</p>
                </div>
            </div>
                ...
                <div className="h-48">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data.confidenceDistribution}>
                            <CartesianGrid strokeDasharray="3 3" stroke="#374151" focusable={false} vertical={false} />
