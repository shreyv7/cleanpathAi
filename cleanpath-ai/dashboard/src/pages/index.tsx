            ...
            <main className="min-h-screen bg-[#030406] text-white font-sans selection:bg-white/20">
                ...
                <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#030406]/80 backdrop-blur-md">
                    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/60">
                            ...
                            <a href="#audit" className="hover:text-white transition-colors">System Audit</a>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button 
                                ...
                                className="text-sm font-medium bg-white text-black px-4 py-2 rounded-full hover:bg-white/90 transition-transform hover:scale-105 active:scale-95 cursor-pointer shadow-lg shadow-white/5"
                            >
                ...
                <section className="relative pt-44 pb-24 px-6 overflow-hidden">
                    ...
                    <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-[11px] font-medium text-white/80 mb-8 backdrop-blur-sm">
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter leading-[1.05] mb-8">
                            ...
                            <span className="text-white/40">for Programmatic Ads.</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4">
                            <button 
                                onClick={() => router.push('/auth/signup')}
                                className="w-full sm:w-auto px-8 py-4 bg-white text-black font-semibold rounded-full flex items-center justify-center gap-2 hover:bg-white/95 hover:-translate-y-0.5 active:translate-y-0 transition-all group cursor-pointer shadow-xl shadow-white/5"
                            >
                                Access Sandbox
                            ...
                            <button 
                                ...
                                className="w-full sm:w-auto px-8 py-4 bg-transparent border border-white/10 text-white/80 font-semibold rounded-full hover:bg-white/5 hover:text-white transition-all cursor-pointer"
                            >
                                Read the Whitepaper
                            </button>
                        </div>
                ...
                {/* Features Grid */}
                <section id="platform" className="py-24 px-6 border-t border-white/5 bg-[#05070B] relative">
                    <div className="max-w-7xl mx-auto">
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold tracking-tight mb-4">A unified control plane for programmatic capital.</h2>
                            <p className="text-white/50 text-base max-w-2xl leading-relaxed">Stop relying on post-bid reporting. CleanPath sits directly on the hot path, modifying bids and routing logic in sub-20 milliseconds.</p>
                        </div>
                ...
                {isWhitepaperOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 sm:p-6 transition-all duration-300">
                        <div className="bg-[#080A0F] border border-white/10 rounded-3xl w-full max-w-4xl h-[85vh] flex flex-col shadow-2xl relative overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                            {/* Modal Header */}
                            <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-[#0B0E14]">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
                                        <Award className="w-4 h-4 text-blue-400" />
                                    </div>
                                    <div>
                                        <div className="text-[10px] text-blue-400 font-bold uppercase tracking-wider font-mono">CP-AUDIT-25REPORT</div>
                                        <h3 className="text-sm font-bold text-white/90">CleanPath AI System Audit Report</h3>
                                    </div>
                                </div>
                                <button 
                            ...
                            {/* Modal Content */}
                            <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 font-sans text-sm text-white/70 leading-relaxed scrollbar-thin">
                                <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-4 flex gap-3 text-xs leading-relaxed text-blue-300/90 font-mono">
                                ...
                                <div>
                                    <h4 className="text-base font-bold text-white mb-3">1. Executive Summary & Core Identity</h4>
                                    <p className="mb-4">
                                ...
                                <div>
                                    <h4 className="text-base font-bold text-white mb-3">2. Systemic Programmatic Vulnerabilities Addressed</h4>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                        <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                                            <span className="font-bold text-white block mb-1">A. Made-For-Advertising (MFA) Arbitrage</span>
                                        ...
                                        <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                                            <span className="font-bold text-white block mb-1">B. Multi-Hop Reseller Commissions</span>
                                            <p className="text-xs text-white/50 leading-relaxed">
                                ...
                                <div>
                                    <h4 className="text-base font-bold text-white mb-3">3. High-Sophistication CTV Emulator Defense</h4>
                                    <p className="mb-4">
                                ...
                                <div>
                                    <h4 className="text-base font-bold text-white mb-3">4. Dynamic Bid Shading via Thompson Sampling</h4>
                                    <p>
                            ...
                            {/* Modal Footer */}
                            <div className="px-6 py-4 border-t border-white/5 bg-[#0B0E14] flex items-center justify-between shrink-0">
                                <span className="text-xs text-white/40 font-mono">CleanPath AI Core Systems Audit</span>
                                <button 
                                    onClick={() => {
